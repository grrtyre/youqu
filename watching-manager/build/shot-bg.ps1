...
$outPath = "$dir\watching-manager.png"
if (Test-Path $outPath) { Remove-Item $outPath -Force }

# Enable demo mode so the app shows sample data for a meaningful screenshot
$env:WM_DEMO = '1'
...
$hwnd = [IntPtr]::Zero
# Title keyword: "watching-manager" (electron default title)
$titleKeyword = [char]0x5267 + [char]0x96c6 + [char]0x7ba1 + [char]0x5bb6  # "watching-manager" in Chinese
for ($i = 0; $i -lt 14; $i++) {
