...
function injectDemoData() {
  ...
  // 今日几条记录
  s.addRecord({ projectId: projects[0].id, start: today0 + 9 * 3600000, end: today0 + 10.5 * 3600000 });
  s.addRecord({ projectId: projects[1].id, start: today0 + 11 * 3600000, end: today0 + 12 * 3600000 });
  s.addRecord({ projectId: projects[0].id, start: today0 + 14 * 3600000, end: today0 + 15.5 * 3600000 });
  // 昨天
