...
| 文件 | 说明 | 大小 | 下载 |
|---|---|---|---|
| Setup.1.0.0.exe | NSIS 安装版 | ~75 MB | [⬇️ 下载](https://github.com/grrtyre/youqu/releases/download/topmost-manager-v1.0.0/Setup.1.0.0.exe) |
| 1.0.0.exe | 便携版（免安装） | ~75 MB | [⬇️ 下载](https://github.com/grrtyre/youqu/releases/download/topmost-manager-v1.0.0/1.0.0.exe) |

> 也可前往 [Releases 页面](https://github.com/grrtyre/youqu/releases/tag/topmost-manager-v1.0.0) 查看所有版本。
...
见上方 [⬇️ 直接下载](#-直接下载) 章节，或前往 [Releases](https://github.com/grrtyre/youqu/releases) 页面。
