...
| 平台 | 下载 | 说明 |
|------|------|------|
| Windows x64 | [重命名管家 Setup 1.1.0](https://github.com/grrtyre/youqu/releases/download/file-rename-manager-v1.1.0/file-rename-manager-setup-1.1.0.exe) | 安装版，支持自定义安装路径 |
| Windows x64 | [重命名管家 Portable 1.1.0](https://github.com/grrtyre/youqu/releases/download/file-rename-manager-v1.1.0/file-rename-manager-portable-1.1.0.exe) | 便携版，解压即用 |
