...
| 版本 | 下载链接 | 说明 |
|---|---|---|
| 安装版（推荐） | [Hosts-Setup-1.1.0.exe](https://github.com/grrtyre/youqu/releases/download/hosts-manager-v1.1.0/Hosts-Setup-1.1.0.exe) | 双击安装，自动创建桌面快捷方式 |
| 免安装便携版 | [Hosts-Portable-1.1.0.exe](https://github.com/grrtyre/youqu/releases/download/hosts-manager-v1.1.0/Hosts-Portable-1.1.0.exe) | 双击即用，不写注册表 |
